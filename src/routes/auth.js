...
const { User,Choferes,Vehiculos,Habilitaciones, sequelizeusers, sequelizelogistica } = require("../modelos.js");
...
router.post('/login', async (req, res)=>{
    ...
    //envio el JWT en header, seria optimo llevarlo en una cookie htttpOnly
})
